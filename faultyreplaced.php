...
$query = "SELECT * FROM card_details_table WHERE CARD_STATUS = 'Faulty & Replaced'";
...
header("Content-Disposition: attachment; filename=Faulty & Replaced_CardsReport_data.xls");
